...
| `zoomMode`                      | `'on'`/`'off'`                         | Enable the pinch to zoom gesture. Default: `on`. If `on`, you must pass `zoom` as `undefined` or avoid setting `zoom` to allow pinch to zoom                                                                                                                                                                                                                                                                                                           |
...
| `allowedBarcodeTypes`           | string[]                               | Limits which barcode formats can be detected. Ex: `['code-128', 'code-39', 'code-93', 'codabar', 'ean-13', 'ean-8', 'itf', 'upc-a', 'upc-e', 'pdf-417', 'aztec', 'data-matrix', 'qr']`. If empty or omitted, all supported formats are scanned.                                                                                                                                                                                                      |
...
| `frameColor`                    | Color                                  | Color of barcode scanner frame visualization. Default: `white` (iOS), `green` (Android)                                                                                                                                                                                                                                                                                                                                                                    |
